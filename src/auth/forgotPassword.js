                        ...
                        <div className="login-content d-flex align-items-center justify-content-center">
                            ...
                            <div className="center">
                              <div className="log-title">
                                ...
                                <form >
                                  <p>Ingresa su correo electrónico personal para enviarle las indicaciones y restaurar su contraseña.</p>

                                    <div className="mb-3">
                                        <label for="exampleFormControlInput1" className="">Correo personal</label>
                                      ...
                                      <button type="submit" className="btn btn-send btn-login mb-3 mt-1" ><Link to="/validation" className='text-white fs-6 text-decoration-none'>Enviar código</Link></button>
